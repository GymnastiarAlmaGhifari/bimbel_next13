    ...
    return (
        <div className="flex flex-col gap-6">
            <p className="text-center">
                Apakah Anda yakin untuk menghapus tagihan <span className="font-semibold">{data?.nama}</span>? <br /> proses akan menghapus semua data yang berhubungan dengan tagihan ini
            </p>

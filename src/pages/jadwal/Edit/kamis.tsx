...
const KamisEdit: FC<KamisEdit> = ({ jadwalId, data, onClose, onSucsess, idRuang }) => {
...
if (user?.length && jadwalIdData?.mapel_id) {
    ...
    const onSubmit: SubmitHandler<FormData> = async (data) => {
        ...
        try {
            ...
            // undefined 
            mutate(`/api/jadwal/hari?hari=KAMIS&ruang_id=${idRuang}`, undefined);
            mutate(`/api/jadwal/hari?hari=${hari}&ruang_id=${ruang}`, undefined);
            // not undefined
            mutate(`/api/jadwal/hari?hari=KAMIS&ruang_id=${idRuang}`);

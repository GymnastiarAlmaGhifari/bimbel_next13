...
const SabtuEdit: FC<SabtuEdit> = ({ jadwalId, data, onClose, onSucsess, idRuang }) => {
    ...
    const onSubmit: SubmitHandler<FormData> = async (data) => {
        ...
        try {
            ...
            // undefined 
            mutate(`/api/jadwal/hari?hari=SABTU&ruang_id=${idRuang}`, undefined);
            mutate(`/api/jadwal/hari?hari=${hari}&ruang_id=${ruang}`, undefined);
            // not undefined
            mutate(`/api/jadwal/hari?hari=SABTU&ruang_id=${idRuang}`);
                                ...
                                <div className="relative flex flex-col gap-2">
                                    ...
                                    >
                                        ...
                                        <span className="text-Neutral-300">
                                            {getHariLabel(watch("hari")) || "Rabu" || "Pilih Hari"}

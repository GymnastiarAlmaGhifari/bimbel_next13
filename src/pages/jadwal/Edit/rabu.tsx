...
const RabuEdit: FC<RabuEdit> = ({ jadwalId, data, onClose, onSucsess, idRuang }) => {
    ...
    const onSubmit: SubmitHandler<FormData> = async (data) => {
        ...
        try {
            ...
            // undefined 
            mutate(`/api/jadwal/hari?hari=RABU&ruang_id=${idRuang}`, undefined);
            mutate(`/api/jadwal/hari?hari=${hari}&ruang_id=${ruang}`, undefined);
            // not undefined
            mutate(`/api/jadwal/hari?hari=RABU&ruang_id=${idRuang}`);

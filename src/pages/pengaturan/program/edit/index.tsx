...
const ProgramEdit: FC<ProgramEditProps> = ({ programId, onClose, data }) => {
  ...
  const levelLabel = data?.level === "PREMIUM" ? "PREMIUM" : data?.level === "REGULER" ? "REGULER" : "Pilih Level";

  const tipeLabel = data?.tipe === "PRIVATE" ? "PRIVATE" : data?.tipe === "SEMI_PRIVATE" ? "SEMI PRIVATE" : data?.tipe === "KELOMPOK" ? "KELOMPOK" : "Pilih Tipe";

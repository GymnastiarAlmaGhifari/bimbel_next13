...
const ResetPassword: FC<ResetPassword> = ({
  onClose,
  onSuccess,
  EmailAddress,
}) => {
  ...
  const passwordConfirmationIcon = showPasswordConfirmation ? (
    <BiHide />
  ) : (
    <BiShow />
  );
    ...
    <div className="flex flex-col gap-6">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-6">
        ...
        {errors.password_lama && (
          <p className="text-red-500 text-sm">{errors.password_lama.message}</p>
        )}
        <Input
          id="password"
          label="Password"

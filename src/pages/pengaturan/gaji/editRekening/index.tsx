...
const RekeningEdit: FC<RekeningEditProps> = ({ rekeningId, data, onSucsess, onClose }) => {
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} className="flex gap-10">
            ...
            />
            {
                errors.nama_rekening && <p className="text-red-500">{errors.nama_rekening.message}</p>
            }
            <Input
                id="nomor_rekening"
            ...
            />
            {
                errors.nomor_rekening && <p className="text-red-500">{errors.nomor_rekening.message}</p>
            }
            <Button
                center
                type="submit"

  ...
  return (
    <div className="flex flex-col bg-Neutral-100 border rounded-lg py-5 px-4 gap-3">
      ...
      <div className="flex justify-between items-center">
        <a href={whatsapp} title="hubungi customer" type="button" target="_blank" id="whatsapp" className="bg-[#4FCF2F] text-neutral_050 shadow-elevation-light-2  hover:bg-[#81FF62] focus:bg-[#4FCF2F]/80 w-11/12 h-12 rounded-2xl flex flex-row gap-3 justify-center items-center">
